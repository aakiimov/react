...
import { Icon28CoinsOutline, Icon16UserOutline } from '@vkontakte/icons';
    ...
    <Panel id={props.id}>
      ...
      <ContentFix>
        <DashboardCard>
          ...
          <SimpleCell before={<Icon28CoinsOutline width={20} height={20} fill="#FFA500" />} indicator="0">Баланс:</SimpleCell>
          <SimpleCell before={<Icon16UserOutline width={20} height={20} />} indicator="Вадим">Никнейм:</SimpleCell>
        </DashboardCard>
      </ContentFix>
    </Panel>
  );
